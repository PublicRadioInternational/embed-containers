(function(base, editorUtil){
	...
	// PUBLIC
	globalBuzzEmbed.prototype.init = function(){
		var self = this;
		self.model = cleanModel();
	};

	globalBuzzEmbed.prototype.initModal = function($el){
		var self = this;
	};
	...
	globalBuzzEmbed.prototype.populateFormWithModel = function($form){
		var self = this;
	...
	globalBuzzEmbed.prototype.editorEvents = function(){};
	...
	editorUtil.embedTypeConstructors[embedName] = globalBuzzEmbed;
